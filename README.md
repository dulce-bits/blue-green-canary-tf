...
| <a name="input_blue_traffic"></a> [blue\_traffic](#input\_blue\_traffic) | Level of traffic distribution to blue environment | `number` | `0` | no |
| <a name="input_enable_blue_env"></a> [enable\_blue\_env](#input\_enable\_blue\_env) | Enable blue environment | `bool` | `false` | no |
...
| <a name="input_green_traffic"></a> [green\_traffic](#input\_green\_traffic) | Level of traffic distribution to green environment | `number` | `100` | no |
